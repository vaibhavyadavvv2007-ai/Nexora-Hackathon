...
class Requirement(BaseModel):
    ...
    source_page: Optional[int] = Field(default=1, ge=1, description="1-indexed PDF page number where requirement appeared")
    confidence: float = Field(default=1.0, ge=0.0, le=1.0, description="Extraction confidence score [0, 1]")
    is_skill_matchable: bool = Field(default=True, description="Whether this requirement is matchable against candidate skills")
